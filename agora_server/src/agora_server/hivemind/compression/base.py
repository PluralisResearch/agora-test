...
class CompressionInfo:
    ...
    part_size: int | None = None  # if tensor is sliced into parts, this is the _maximum_ number of values per part
    ...
    def get_part(self, part_index: int, part_size: int | None):
