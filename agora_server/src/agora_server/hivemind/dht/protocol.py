...
from agora_server.hivemind.dht.routing import DHTID, BinaryDHTValue, RoutingTable, Subkey
from agora_server.hivemind.dht.storage import DHTLocalStorage, DictionaryDHTValue
from agora_server.hivemind.p2p import P2P, P2PContext, PeerID, ServicerBase
from agora_server.hivemind.proto import dht_pb2
from agora_server.hivemind.utils import MSGPackSerializer, get_logger
from agora_server.hivemind.utils.auth import AuthorizerBase, AuthRole, AuthRPCWrapper
...
class DHTProtocol(ServicerBase):
    ...
    record_validator: RecordValidatorBase | None
    # fmt: on
    ...
    async def call_ping(self, peer: PeerID, validate: bool = False, strict: bool = True) -> DHTID | None:
        """
    ...
    async def call_store(
        ...
        peer: PeerID,
        keys: Sequence[DHTID],
        values: Sequence[BinaryDHTValue | DictionaryDHTValue],
        expiration_time: DHTExpiration | Sequence[DHTExpiration],
        subkeys: Subkey | Sequence[Subkey | None] | None = None,
        in_cache: bool | Sequence[bool] | None = None,
    ) -> list[bool] | None:
        """
    ...
    async def call_find(
        ...
        dict[DHTID, tuple[ValueWithExpiration[BinaryDHTValue | DictionaryDHTValue] | None, dict[DHTID, PeerID]]] | None
    ):
        """
    ...
    async def update_routing_table(self, node_id: DHTID | None, peer_id: PeerID, responded=True):
        """
