...
from agora_server.hivemind.utils import MSGPackSerializer, get_dht_time
...
class RoutingTable:
    ...
    def add_or_update_node(self, node_id: DHTID, peer_id: PeerID) -> tuple[DHTID, PeerID] | None:
        """
    ...
    def get(self, *, node_id: DHTID | None = None, peer_id: PeerID | None = None, default=None):
    ...
    def __getitem__(self, item: DHTID | PeerID) -> PeerID | DHTID:
        """Find peer_id for a given DHTID or vice versa"""
    ...
    def __contains__(self, item: DHTID | PeerID) -> bool:
    ...
    def get_nearest_neighbors(
        self, query_id: DHTID, k: int, exclude: DHTID | None = None
...
class KBucket:
    ...
    def request_ping_node(self) -> tuple[DHTID, PeerID] | None:
...
class DHTID(int):
    ...
    @classmethod
    def generate(cls, source: Any | None = None, nbits: int = 255):
        """
    ...
    def xor_distance(self, other: DHTID | Sequence[DHTID]) -> int | list[int]:
        """
