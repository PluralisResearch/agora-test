...
from agora_server.hivemind.dht.routing import DHTID
from agora_server.hivemind.dht.validation import DHTRecord, RecordValidatorBase
...
class SchemaValidator(RecordValidatorBase):
    ...
    def __init__(self, schema: type[pydantic.BaseModel], allow_extra_keys: bool = True, prefix: str | None = None):
        """
