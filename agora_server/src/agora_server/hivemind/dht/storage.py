...
from agora_server.hivemind.dht.routing import DHTID, BinaryDHTValue, Subkey
from agora_server.hivemind.utils.serializer import MSGPackSerializer
from agora_server.hivemind.utils.timed_storage import DHTExpiration, KeyType, TimedStorage, ValueType
...
class DHTLocalStorage(TimedStorage[DHTID, Union[BinaryDHTValue, DictionaryDHTValue]]):
    ...
    def store(
        self, key: DHTID, value: BinaryDHTValue, expiration_time: DHTExpiration, subkey: Subkey | None = None
    ) -> bool:
        """
