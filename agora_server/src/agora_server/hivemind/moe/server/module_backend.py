...
from agora_server.hivemind.utils.nested import nested_compare, nested_flatten, nested_map, nested_pack
...
class ModuleBackend:
    ...
    def __init__(
        ...
        *,
        ...
        scheduler: LRSchedulerBase | None = None,
        args_schema: tuple[BatchTensorDescriptor, ...] = None,
        kwargs_schema: dict[str, BatchTensorDescriptor] = None,
        outputs_schema: BatchTensorDescriptor | tuple[BatchTensorDescriptor, ...] = None,
        **kwargs,
    ):
        super().__init__()
